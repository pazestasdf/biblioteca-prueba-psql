...
id_libro INTEGER NOT NULL REFERENCES libros (ISBN),
socio VARCHAR (255),
libro VARCHAR (255),
...
\copy libros(ISBN,titulo,cod_autor,nombre_autor,apellido_autor,nacimiento_muerte,tipo_autor,dias_prestamo) from '/Users/mariapazcarrascoojeda/Desktop/basesdatos/prueba/libros.csv' csv header;
